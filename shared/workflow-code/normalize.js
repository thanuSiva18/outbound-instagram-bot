...
// -- DEDUP LAYER 1: synchronous same-message guard. Catches immediate re-delivery
//    of the IDENTICAL text (Layer 2 below handles the truly-parallel burst). --
...
// prompts/system_prompt.md. knownJson + notesBlock + flags injected at runtime; persona fixed (Zayn).
